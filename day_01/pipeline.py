...
deltas edificio-vs-aldea). Categóricas (incluido `geo_level_*_id`)
manejadas nativamente por cada librería.

Outputs:
  - submissions/submission.csv  (predicciones del ensemble en test)
...
# ---------------------------------------------------------------------------
# Cargar + Feature engineering (mismo que feateng.py y ensemble_v2.py)
# ---------------------------------------------------------------------------
...
print(f"CatBoost best_iter medio: {int(np.mean(best_iters_cb))}")

# ---------------------------------------------------------------------------
# Submission ensemble (entrena ambos en train completo)
# ---------------------------------------------------------------------------
